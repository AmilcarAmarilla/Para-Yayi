function createFlower() {
    ...
    // Número máximo de flores a crear simultáneamente (entre 3 y 6)
    const maxFlowers = Math.ceil(Math.random() * 6 + 3);
    ...
    for (let j = 0; j < maxFlowers; j++) {
        ...
        for (let i = 1; i <= 10; i++) {
            ...
            // Tiempo aleatorio de desaparición entre 5 y 7 segundos
...
setInterval(createFlower, 1000); // Nuevas flores cada 2 segundos